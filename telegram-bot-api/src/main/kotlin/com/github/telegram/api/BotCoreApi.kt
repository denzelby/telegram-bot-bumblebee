...
interface BotCoreApi {
    ...
    fun sendPhoto(
            ...
            // telegram api requires "filename" in Content-Disposition header
            @Part("photo\"; filename=\"photo\"") photo: RequestBody,
    ...
    @POST("setWebhook")
    fun removeWebhook(): Call<Response<Unit>>
}